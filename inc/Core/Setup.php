	...
	public function register_sidebars() {
		...
		register_sidebar(
			array(
				...
				'description'   => __( 'Bloco sticky no rodapé. Slot fixo: 90px no desktop e 40px no mobile. No widget HTML, use um banner AdSense horizontal nesse tamanho — o anúncio se adapta ao layout, não o contrário.', 'aptox' ),
				'before_widget' => '<div id="%1$s" class="aptox-sticky-chrome__widget %2$s">',
				'after_widget'  => '</div>',
				'before_title'  => '<span class="screen-reader-text">',
				'after_title'   => '</span>',
			)
